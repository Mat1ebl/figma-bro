...
const chu2 =() => {
  return (
     <div className="display flex justify-center mt-[16px] ml-[-630px]">
             <div className="flex">
               <div className="w-[322px] h-[438px] bg-white rounded-2xl shadow-xl shadow-indigo-500/50 hover:bg-[#FFCC00]">
              ...
              <div className="absolute display flex justify-center">
                        <div className="w-[322px] h-[438px] bg-[#ffffff] rounded-2xl shadow-xl ml-[650px] shadow-indigo-500/50 hover:bg-[#007BFF]">
                          <div className=" text-center items-center flex flex-col justify-between p-11 h-full">
              ...
              <div className="absolute">
                        <div className="w-[322px] h-[438px] bg-[#ffffff] rounded-2xl shadow-xl ml-[1300px] shadow-indigo-500/50 hover:bg-[#f18b16]">
                          <div className=" text-center items-center flex flex-col justify-between p-11 h-full">
